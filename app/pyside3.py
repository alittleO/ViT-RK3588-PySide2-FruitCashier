...
class CameraApp(QMainWindow):
    def __init__(self):
        ...
        self.capture_button.setMinimumSize(100, 50)  # 设置按钮的最小尺寸

        self.tare_button = QPushButton("去皮", self)  # 创建去皮按钮
        self.tare_button.clicked.connect(self.perform_tare)
        self.tare_button.setMinimumSize(100, 50)  # 设置按钮的最小尺寸
        ...
        self.weight_price_info = QLabel(" ", self)
        ...
        if self.serial.inWaiting() > 0:
            ...
            if line.startswith('weight='):
                ...
                try:
                    ...
                    self.weight_price_info.setText(f"去皮重量: {self.qupi:.3f} kg {self.qupi*2:.3f}斤")
                except ValueError:
